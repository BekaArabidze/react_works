...
import { selectAllTodos, deleteTodo, deleteAllTodos, toggleTodo, addTodo, updateTodo } from "../../redux/todoSlice"
...
const Todos = () => {
    ...
    return (
        <>
            ...
            {
                todos.length === 0 ? "no more todos"
                    :
                    <button onClick={() => dispatch(deleteAllTodos())}>delete all todos</button>
            }
        </>
    )
}
